...
path2phenolyzer_out <- "/media/data/lanpd/driver_gene_project/dataset/THCA-US/data/DO39720/DO39720.annotated_gene_list"
...
driver_prob_df <- prioritize_driver_genes(features_df = features_df,
                                          cancer_type = "THCA")
write.csv(driver_prob_df,file='/media/data/lanpd/driver_gene_project/dataset/THCA-US/data/DO39720/DO39720_result.csv', row.names=FALSE)
